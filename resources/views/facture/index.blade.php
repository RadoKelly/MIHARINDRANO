            ...
            <div class="header">
                ...
                <div class="faktiora-header">
                    ...
                    <div class="row">
                        ...
                        <div class="row-value">
                            <div class="input-box">{{ \Carbon\Carbon::parse($compteur->date_releve)->translatedFormat('F/Y') }}
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="faktiora-section">
                ...
                <table class="table-ketra">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="label">Faktiora <strong> {{ \Carbon\Carbon::parse($compteur->date_releve)->translatedFormat('F/Y') }}</strong> </td>
