...
<head>
    <meta charset="UTF-8">
    <title>FAKTIORA - A4 Paysage (Dompdf)</title>
    <style>
        ...
        /* Utiliser display: table au lieu de float pour une meilleure compatibilité Dompdf */
        .invoice-wrapper {
            width: 100%;
            display: table;
            table-layout: fixed;
        ...
        /* Séparateur exactement au milieu */
        .invoice-block.left {
        ...
        /* Totaux section: utiliser display: table au lieu de float */
        .totals-container {
            width: 100%;
            display: table;
            table-layout: fixed;
        ...
        /* Réduire légèrement les marges pour plus d'espace */
        .main-table th,
        .main-table td {
            padding: 1.5mm;
        }
